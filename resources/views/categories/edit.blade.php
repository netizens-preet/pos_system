            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form
                        ...
                        method="POST">
                        @csrf//Insert hidden Cross-Site Request Forgery for prevention of unauthorized requests to the server
                        @if(isset($category)) // Blade conditional that checks if the $category variable exists
                            @method('PUT')
                        @endif
